...
<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-6">
            ...
            {!! Form::select('expense_head_id', $expense_head_list,Input::old('expense_head_id'),['class' => 'form-control','required','title'=>'select expense head']) !!}
        </div>
        <div class="col-sm-6">
            {!! Form::label('expense_subhead_id', 'Expense SubHead:', ['class' => 'control-label']) !!}
            <small class="required">(Required)</small>
            {!! Form::select('expense_subhead_id', $expense_subhead_list,Input::old('expense_subhead_id'),['class' => 'form-control','required','title'=>'select expense head']) !!}
        </div>
