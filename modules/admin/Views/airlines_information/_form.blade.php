...
<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-12">
            ...
            {!! Form::select('country_id', $country_list,Input::old('country_id'),['id'=>'country_id','class' => 'form-control','required','title'=>'select country']) !!}
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            {!! Form::label('airlines_name', 'Airlines Name:', ['class' => 'control-label']) !!}
            <small class="required">(Required)</small>
            {!! Form::text('airlines_name', Input::old('airlines_name'), ['id'=>'airlines_name', 'class' => 'form-control', 'style'=>'text-transform:capitalize','required']) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
