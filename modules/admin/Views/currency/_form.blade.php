...
<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            {!! Form::select('domestic', array('yes'=>'Yes','no'=>'No'),Input::old('domestic'),['class' => 'form-control','required','title'=>'select domestic']) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            ...
            <small class="required">(Required)</small>
            {!! Form::text('conversion_to', Input::old('conversion_to')?Input::old('conversion_to'):'1', ['id'=>'conversion_to', 'class' => 'form-control', 'style'=>'text-transform:capitalize','required','name'=>'conversion_to']) !!}
        </div>
        <div class="col-sm-6">
...
<script>
    $(function(){
        $('#domestic').change(function(event){
            var value = $(this).val();
            if(value == 'yes'){
                $('#conversion_to').val('1');
            }else{
