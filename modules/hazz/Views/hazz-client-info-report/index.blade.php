...
@section('content')
    ...
    <!-- page start-->
    <div class="">
        <div class="header-searchbar" style="width: 85.3%">
            <section>
                <header class="panel-heading">
                    ...
                    <div id="collapsible-searchbox"
                         class="collapse">
                        {!! Form::open(['method' =>'POST','route'=>'generate-hazz-client-info-report','id'=>'submit','class'=>'report-form']) !!}
                        <div class="row">
                            <div class="col-xs-4">
                    ...
                    <div class="row">
                        <table class="display table table-bordered table-striped dataTable"
                            ...
                            <thead>
                            <tr>
                                <th style="width: 16.67%;">Client Name</th>
                                <th style="width: 16.67%;">Passport No</th>
                                <th style="width: 16.67%;">Booking Date</th>
                                <th style="width: 16.67%;">Hazz Fair</th>
                                <th style="width: 16.67%;">Receive Amount</th>
                                <th style="width: 16.67%;">Due Amount</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
            ...
            <table class="tbl">
                ...
                @if(isset($data))
                    ...
                    @foreach($data as $values)
                        <tr class="gradeX">
                            <td style="width: 16.67%;">{{$values->client_name}}</td>
                            <td style="width: 16.67%;">{{$values->passport_no}}</td>
                            <td style="width: 16.67%;">{{$values->booking_date}}</td>
                            <td style="width: 16.67%;">{{$values->hazz_fair}}</td>
                            <td style="width: 16.67%;">
                                {{ isset($values->relHazzClientPaymentReceive) ? $values->relHazzClientPaymentReceive->sum('receive_amount') : 'N/A' }}
                            </td>
                            <?php
                            ...
                            ?>
                            <td style="width: 16.67%;">{{ $dueAmount or 'N/A' }}</td>
                        </tr>
                    @endforeach
                @endif
                </tbody>
