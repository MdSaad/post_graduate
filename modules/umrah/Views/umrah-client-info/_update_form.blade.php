...
<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
        ...
        <div class="col-sm-6">
            ...
            <div class="input-group">
                <input name="booking_date"
                       type="text"
                       id="date"
                       value="{{ isset($data->booking_date) ? $data->booking_date : '' }}"
                       class="form-control datepicker1" required/>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <small class="required">(Required)</small>
            {!! Form::text('umrah_fair', Input::old('umrah_fair'), ['id'=>'umrah_fair', 'class' => 'form-control', 'style'=>'text-transform:capitalize','required']) !!}
        </div>
        <div class="col-sm-6">
